 ...
 */
@WebServlet("/RResetPassServ")
public class RResetPassServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RResetPassServ() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(oldpass.equals(old))
			{
				...
				{
					response.sendRedirect("Real/ResetPass.jsp?err=1");
				}
				
			}
			else
			{
				response.sendRedirect("Real/ResetPass.jsp?msg=1");
			}
