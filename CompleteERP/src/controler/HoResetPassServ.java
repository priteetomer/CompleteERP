 ...
 */
@WebServlet("/HoResetPassServ")
public class HoResetPassServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HoResetPassServ() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(oldpass.equals(old))
			{
				...
				{
					response.sendRedirect("Hospitality/ResetPass.jsp?err=1");
				}
				
			}
			else
			{
				response.sendRedirect("Hospitality/ResetPass.jsp?msg=1");
			}
