 ...
 */
@WebServlet("/EApproveLeaveServ")
public class EApproveLeaveServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EApproveLeaveServ() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			response.sendRedirect("Education/HRLeaveDetail.jsp");
		}
		catch(Exception e )
		{
			e.printStackTrace();
