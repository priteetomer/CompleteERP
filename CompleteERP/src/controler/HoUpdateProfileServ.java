 ...
 */
@WebServlet("/HoUpdateProfileServ")
public class HoUpdateProfileServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HoUpdateProfileServ() {
        super();
	...
	String mail =(String)s.getAttribute("email");
		...
		response.sendRedirect("Hospitality/Profile.jsp");
	}
