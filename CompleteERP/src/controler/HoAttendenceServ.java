 ...
 */
@WebServlet("/HoAttendenceServ")
public class HoAttendenceServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HoAttendenceServ() {
        super();
		 ...
		 Date date = new Date();
		  ...
		  HttpSession se =request.getSession();
			int rid = (Integer)se.getAttribute("rid");
						if( rid ==1)
						{
							response.sendRedirect("Hospitality/FinanceIndex.jsp");
						...
						{ 
							response.sendRedirect("Hospitality/EmpIndex.jsp");
