 ...
 */
@WebServlet("/HExpensereportServ")
public class HExpensereportServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HExpensereportServ() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("Health/ExpenseReport.jsp");
		}
		catch(Exception e )
		{
			e.printStackTrace();
