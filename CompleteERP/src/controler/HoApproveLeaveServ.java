 ...
 */
@WebServlet("/HoApproveLeaveServ")
public class HoApproveLeaveServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HoApproveLeaveServ() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			response.sendRedirect("Hospitality/HRLeaveDetail.jsp");
		}
		catch(Exception e )
		{
			e.printStackTrace();
