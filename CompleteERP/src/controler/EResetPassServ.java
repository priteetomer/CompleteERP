 ...
 */
@WebServlet("/EResetPassServ")
public class EResetPassServ extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EResetPassServ() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(oldpass.equals(old))
			{
				...
				{
					response.sendRedirect("Education/ResetPass.jsp?err=1");
				}
				
			}
			else
			{
				response.sendRedirect("Education/ResetPass.jsp?msg=1");
			}
