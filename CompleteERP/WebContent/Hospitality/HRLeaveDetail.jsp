...
<div class="container col-sm-12 wow zoomIn">
 ...
 <th>LastName</th>
  ...
  <tr>
  	...
  	<td colspan="2"><a href="../HoApproveLeaveServ?id=${stdlev.id}" rel="tooltip" title="Approve"><i class="fa fa-check"></i></a>
  					<a href="../HoRejectLeaveServ?id=${stdlev.id}" rel="tooltip" title="Reject"><i style="margin-left:10px;" class="fa fa-close"></i></a>
