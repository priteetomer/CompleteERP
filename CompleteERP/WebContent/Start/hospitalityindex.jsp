        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                             <img alt="" src="images/favicon/hospitality.png">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <div class="navigation-menu">
                            <div class="navbar">
                                ...
                                <li><a class="smoth-scroll" href="../Hospitality/Login.jsp">Login/SignUp</a>
                                        </li>
                                </ul>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="active"><a class="smoth-scroll" href="../HospitalityIndex.jsp">Home</a>
                                        </li>
          ...
          <div class="row">
                <div class="col-sm-12">
                    <div class="section-title">
                        ...
                        <p>Converting Business into Technology</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
               ...
               <p>INFOWEB is an IT company in India. We expertise in various proficient fields
                    as Website development,Website designing,Logo Design,Asp.Net Development,PHP Development,Mobile App Development,Domain Register and Web Hosting, SEO services. We are unique among the other
                    IT companies in India, as we give fully dedication, professionalism and reliable
                    towards the work.</p>
               </div>
              </div>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12 uipasta-credit">
                <p>Design By <a href="http://www.uipasta.com" target="_blank" title="UiPasta">Infoweb</a></p>
                </div>
