        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                             <img alt="" src="images/favicon/education.png">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <div class="navigation-menu">
                            <div class="navbar">
                                ...
                                <li><a class="smoth-scroll" href="../Education/Login.jsp">Login/SignUp</a>
                                        </li>
                                </ul>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="active"><a class="smoth-scroll" href="../EduIndex.jsp">Home </a>
                                        </li>
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
               ...
               <p>Education is a misson to provide quality education to people receiving government assistance..</p>
               </div>
              </div>
