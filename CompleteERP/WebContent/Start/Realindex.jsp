        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                             <img alt="" src="images/favicon/real.png">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <div class="navigation-menu">
                            <div class="navbar">
                                ...
                                <li><a class="smoth-scroll" href="../Real/Login.jsp">Login/SignUp</a>
                                        </li>
                                </ul>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="active"><a class="smoth-scroll" href="../RealIndex.jsp">Home</a>
                                        </li>
