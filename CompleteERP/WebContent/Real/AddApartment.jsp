...
<section id="menu-area">
	...
	<div id="login-content" class="modal-content" style="width:350px; ">
		<div class="modal-header">
			<h4 class="modal-title" align="center">Add Apartment</h4>
		</div>
		<div class="modal-body">
			<form action="../AddApartment" method="post" name="apartment" id="apartment" >
				<table>
					<tr>
						<td>
							<div class="form-group"  >
								<input  style="margin-left:40px;" type="text"
									placeholder="Appartment Name"  name="aname"   id="aname" class="form-control and validate[required,custom[onlyLetterSp]]" >
						...
						<td>
							<div class="form-group">
								<input  style="margin-left:40px;" type="text"
									placeholder="Appartment cost" name="acost"  id="acost"
              ...
              Appartment type:<select name="atype" class="form-control">
              	<option>1 BHK</option>
              	<option>2 BHK</option>
              	<option>3 BHK</option>
              	<option>5 BHK</option>
						...
						<td>
							<div class="form-group">
								<textarea style=" margin-left:40px;" type="text" placeholder="Apartment Description"
									name="adesc" id="adesc"  class="form-control and validate[required]"></textarea>
							</div>
						</td>
					</tr>
					</table>
					<table>
						...
						<td>
							<div class="form-group">
								<textarea style=" margin-left:40px;" type="text" placeholder="Address"
