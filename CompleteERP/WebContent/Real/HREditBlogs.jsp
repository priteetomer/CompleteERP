...
<table class="table table-striped table-bordered" id="tbldata" cellspacing="0" width="100%">
  ...
  <td colspan="2"><a href="../RUpdateNewsServlet?id=${bl.id}" rel="tooltip" title="To Update"><i style="margin-left:10px;" class="fa fa-pencil-square-o"></i></a>
  					<a href="../RDeleteNewsServlet?id=${bl.id}" rel="tooltip" title="To Delete"><i style="margin-left:20px;" class="fa fa-trash-o"></i></a></td>
