      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="../Start/Realindex.jsp">Home</a></li>
            <li><a href="../Start/Realindex.jsp">About</a></li>
            <li><a href="../Start/Realindex.jsp">Services</a></li>             
            <li><a href="../Start/Realindex.jsp">ContactUs</a></li>
 ...
 <div class="modal-dialog wow zoomIn">
      ...
      <div id="login-content" class="modal-content" style="width:400px; margin-left:100px; margin-top:50px;">
        ...
        <div class="modal-body">
          <form action="../RLoginServlet" name="registration" id="registration" method="post" >
