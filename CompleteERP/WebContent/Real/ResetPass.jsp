...
<%HttpSession se =request.getSession();
	int rid = (Integer)se.getAttribute("rid");
				...
				{  %>
					<jsp:include page="ClientMenubar.jsp"></jsp:include>
	...
	<div id="login-content" class="modal-content" style="width: 350px;">
		...
		<div class="modal-body ">
			<form action="../RResetPassServ" method="post">
      ...
      <div class="row" >
        <div class="col-md-6 col-sm-6">
          <div class="footer-left">
           <h4  >  All Right Reserve &copy; Copyright 2016 <a href="Index.jsp" target="_blank">ERP SYSTEMS AHMEDABAD</a></h4>
          </div>
        </div>
        <div class="col-md-6 col-sm-6">
