...
<section id="menu-area">
	...
	<div id="login-content" class="modal-content" style="width:350px; ">
		<div class="modal-header">
			<h4 class="modal-title" align="center">Add Student</h4>
		</div>
		<div class="modal-body">
			<form action="../AddStudent" method="post" name="student" id="student" >
				<table>
					<tr>
						<td>
						...
						<td>
							<div class="form-group">
								<input style="margin-left: 10px;" type="text" placeholder="Email" name="email"  id="EmailAddress" class="form-control and validate[required,custom[email]"]>
							</div>
						</td>
