    ...
    <nav class="navbar navbar-inverse"  role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- TEXT BASED LOGO -->
         <div class="logo">
                             <img alt="" src="../asset/images/education.png">
                        </div>             
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="../Start/Eduindex.jsp">Home</a></li>
            <li><a href="../Start/Eduindex.jsp">About</a></li>
            <li><a href="../Start/Eduindex.jsp">Services</a></li>             
            <li><a href="../Start/Eduindex.jsp">ContactUs</a></li>
 ...
 <div class="modal-dialog wow zoomIn">
      ...
      <div id="login-content" class="modal-content" style="width:400px; margin-left:100px; margin-top:50px;">
        ...
        <div class="modal-body">
          <form action="../ELoginServlet" name="registration" id="registration" method="post" >
