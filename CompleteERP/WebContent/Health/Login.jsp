      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            <li class="active"><a href="../Start/healthindex.jsp">Home</a></li>
            <li><a href="../Start/healthindex.jsp">About</a></li>
            <li><a href="../Start/healthindex.jsp">Services</a></li>             
            <li><a href="../Start/healthindex.jsp">ContactUs</a></li>
