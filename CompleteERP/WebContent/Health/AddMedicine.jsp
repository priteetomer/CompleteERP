...
<section id="menu-area">
	...
	<div id="login-content" class="modal-content" style="width:350px; ">
		<div class="modal-header">
			<h4 class="modal-title" align="center">Add Medicine</h4>
		</div>
		<div class="modal-body">
			<form action="../AddMedicine" method="post" name="medicine" id="medicine" >
				<table>
					<tr>
						<td>
							<div class="form-group"  >
								<input  style="margin-left:40px;" type="text"
									placeholder="Medicine Name"  name="mname"   id="mname" class="form-control and validate[required,custom[onlyLetterSp]]" >
						...
						<td>
							<div class="form-group">
								<input  style="margin-left:40px;" type="text"
									placeholder="Medicine cost per unit" name="mcost"  id="mcost"
				...
				<tr>
						<td>
							<div class="form-group">
								<input style="margin-left:40px;" type="text"
									placeholder="Manufacture Date" name="mdate" id="mdate" 
									class="form-control and validate[required,custom[onlyLetterSp]]">
							</div>
						</td>
				</tr>
              ...
              Medicine manufacturer:<select name="mtype" class="form-control">
              	<option>Cadilla</option>
              	...
              	<option>Ranbaxy</option>
						...
						<td>
							<div class="form-group">
								<textarea style=" margin-left:40px;" type="text" placeholder="Medicine Description"
									name="mdesc" id="mdesc"  class="form-control and validate[required]"></textarea>
							</div>
						</td>
					</tr>
					</table>
